...
baseline$OECD <- factor(baseline$OECD, levels = c(0,1), 
                        labels = c("No OECD membership", "OECD membership"))
...
units(baseline$popdens) <- "% of population living in 
a density of >1,000 people/km^2"

## Create Table 1 #######

cat("Table 1: Summary of Baseline Characteristics for Countries in the Year 2000 by Presence of Armed Conflict Factor\n")

table1(~ gdp1000 + OECD + popdens + urban + agedep + male_edu + 
