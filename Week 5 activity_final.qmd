...
baseline$OECDf <- factor(baseline$OECD, levels = c(0,1), labels = c("No OECD membership", "OECD membership"))
...
mytable1 <-table1(~ gdp1000 + OECDf + popdens + urban + agedep + male_edu + temp + rainfall1000 + earthquakef + droughtf| armconf1f, data = baseline, render.continuous = c(.="Median [Min, Max]"), overall=c(left="Total"))
